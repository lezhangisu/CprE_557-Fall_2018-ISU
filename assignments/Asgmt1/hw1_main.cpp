...
//
// Modified by Le Zhang on 9/6/2018 for CprE557 Assignment 1
...
int main(int argc, const char * argv[])
{
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        // I changed the gap between two models to be narrower -- Le Zhang
        modelMatrix = glm::translate(glm::mat4(1.0f), glm::vec3(3.5f, 0.0f, 0.0f));
        glUniformMatrix4fv(modelMatrixLocation, 1, GL_FALSE, &modelMatrix[0][0]); // Send our model matrix to the shader
		...
		// This line renders your Ppolygon model (you mean triangle model?)
		renderTriangleModel();
